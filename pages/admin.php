...
$category = "";
$url = htmlspecialchars("admin.php?page=");
if (isset($_GET['c'])){
  if ($_GET['c'] == ""){
    header('Location: admin.php?c=all&page=1');
  }
    $category = $_GET['c'];
} else {
    header("Location: admin.php?c=all&page=1");
...
if (isset($_GET['page'])){
    if ($_GET['page'] <= 0 || !is_numeric($_GET['page'])){
        header("Location: admin.php?c=$category&page=1");
    }
...
function generatePaginationLink($page_number, $text, $is_active = false) {
    ...
    return "<li class='page-item$active_class'><a class='page-link' href='admin.php?c=" . urlencode($category) . "&page=$page_number'>$text</a></li>";
}
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0" id="listToUpdate">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="admin.php?c=all&page=1"><b>all Fans</b></a></li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="admin.php?c=tower&page=1">Tower Fans</a></li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="admin.php?c=table&page=1">Table Fans</a></li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="admin.php?c=ceiling&page=1">Ceiling Fans</a></li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="admin.php?c=handheld&page=1">Handheld Fans</a></li>
            </ul>
          </li>
          <li class="nav-item">
