...
<body>
    <div class="container">
        ...
        <p>Only Fans is an online platform that allows users to upload, share, and comment on images of fans. The Service includes all aspects of Only Fans, including but not limited to all products, software, and services offered via the Website.</p>

        <h2>3. Eligibility</h2>
        <p>You must be at least 13 years old to use the Website. By using the Website, you represent and warrant that you are at least 13 years old and have the legal capacity to enter into a binding contract.</p>

        <h2>4. User Accounts</h2>
        <p>You may be required to create an account to use some features of the Website. You must provide accurate and complete information and keep your account information updated. You are solely responsible for the activity that occurs on your account, and you must keep your account password secure. You must notify Only Fans immediately of any breach of security or unauthorized use of your account.</p>

        <h2>5. User Content</h2>
        <h3>5.1 Ownership</h3>
        <p>You retain all ownership rights in the images and comments you upload ("User Content"). By uploading User Content, you grant Only Fans a worldwide, non-exclusive, royalty-free, sublicenseable, and transferable license to use, reproduce, distribute, prepare derivative works of, display, and perform the User Content in connection with the Website and Only Fans's (and its successors' and affiliates') business, including without limitation for promoting and redistributing part or all of the Website (and derivative works thereof) in any media formats and through any media channels.</p>

        <h3>5.2 Prohibited Content</h3>
        <p>You agree not to upload any User Content that:</p>
        <ul>
        ...
        <h3>5.3 Monitoring and Removal</h3>
        <p>Only Fans has the right, but not the obligation, to monitor and review User Content and to remove any User Content that, in its sole discretion, violates these Terms or is otherwise objectionable. You acknowledge and agree that Only Fans may access, preserve, and disclose your account information and User Content if required to do so by law or in a good faith belief that such access, preservation, or disclosure is reasonably necessary to (i) comply with legal process; (ii) enforce these Terms; (iii) respond to claims that any User Content violates the rights of third parties; (iv) respond to your requests for customer service; or (v) protect the rights, property, or personal safety of Only Fans, its users, and the public.</p>

        <h2>6. Prohibited Conduct</h2>
        <p>You agree not to engage in any of the following prohibited activities:</p>
        <ul>
            <li>Copying, distributing, or disclosing any part of the Website in any medium;</li>
            <li>Using any automated system, including without limitation "robots," "spiders," "offline readers," etc., to access the Website in a manner that sends more request messages to the Only Fans servers than a human can reasonably produce in the same period of time by using a conventional on-line web browser;</li>
        ...
        <h2>7. Privacy</h2>
        <p>Your privacy is important to us. Our Privacy Policy explains how we collect, use, and protect your information when you use the Website. By using the Website, you agree to the terms of the Privacy Policy.</p>

        <h2>8. Intellectual Property</h2>
        <p>The Website and its original content (excluding User Content), features, and functionality are and will remain the exclusive property of Only Fans and its licensors. The Website is protected by copyright, trademark, and other laws of both the United States and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Only Fans.</p>
