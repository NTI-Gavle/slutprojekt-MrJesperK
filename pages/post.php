...
if ($likedPost){
 $likesIcon = "<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-heart-fill' viewBox='0 0 16 16'>
 <path fill-rule='evenodd' d='M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314'/>
 </svg>";
} else {
  $likesIcon = "<svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-heart' viewBox='0 0 16 16'>
...
<div class="card m-3" style="width: 50rem;">
  ...
  <ul class="list-group list-group-flush text-start">
    ...
    <li class="list-group-item"><form method="post" id="likeForm" onsubmit="return likePost(event)"><button class="btn btn-success position-relative text-center" type="submit" name="like" id="like"><?php echo $likesIcon ?></button></form></li>
