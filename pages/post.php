...
echo "<button class='btn btn-primary mt-4 z-3' data-bs-target='#CommentModal' data-bs-toggle='modal' onlick='modal3()'>Comment</button>";
?>

    </div>
</div>

<div class="container d-flex float-end text-center p-0 z-0 position-absolute" style="right: 20rem; top: -15rem;">
    <div class=" m-auto justify-content-center z-0 border">
        <?php
...
<div class="modal fade" id="ReplyModal" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="ModalLabel"><?php echo $Comments['ID']; ?></h1>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="" method="post">
      <div class="modal-body d-flex flex-column mb-3 gap-3">
        <textarea name="ReplyText" id=ReplyText" cols="20" rows="10" placeholder="Reply"></textarea>
      </div>
      <div class="modal-footer">
        <img src="../image/sus.png" alt="sus" style="width:3rem; height:3rem;">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <input type="submit" class="btn btn-primary" value="Reply" name="Reply" id="Reply"></input>
      </div>
      </form>
    </div>
  </div>
...
<div class="d-flex flex-column justify-content-center align-self-center position-relative m-auto border-start border-end" style="width:70rem; height:fit-content; top:14rem;">
    ...
    <div>
        ...
        <button class='btn btn-primary mt-4 z-3 position-relative' style="bottom:1.5rem; right:-1rem;" data-bs-target='#ReplyModal' data-bs-toggle='modal' onclick='modal4()'>Reply</button>
        <?php endforeach; ?>
